...
const BannerList = ({ isLoading, banners }) => {
  ...
  // Check if banners is defined and has the expected structure
  if (!banners || !banners.card || !banners.card.card || !banners.card.card.gridElements || !banners.card.card.gridElements.infoWithStyle || !banners.card.card.gridElements.infoWithStyle.info) {
    return <div></div>; // Handle case when banners data is not available
  }
